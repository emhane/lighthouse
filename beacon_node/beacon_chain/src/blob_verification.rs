...
impl<T: BeaconChainTypes> AvailabilityPendingExecutedBlock<T> {
    pub fn new(block: ExecutedBlock<T, AvailabilityPendingBlock<T::EthSpec>>) -> Self {
        AvailabilityPendingExecutedBlock(Box::new(block))
    }
}
